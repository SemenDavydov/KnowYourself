...
public class Player
{
    ...
    public Player(string nick, string c1, string c2, string c3)
    {
        nickname = nick;
        colorMain = c1;
        colorSecond = c2;
    ...
    public void SetThierdColor(string color) => colorThierd = color;
...
public class WebManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        userData.playerData = new Player("Player", "", "", "");
    }
    ...
    public void SaveData(int id, string nickname, string main, string second, string thierd)
    {
        StopAllCoroutines();
        SaveProgress(id, nickname, main, second, thierd);
    }
    ...
    public void SaveProgress(int id, string nickname, string main, string second, string thierd)
    {
        WWWForm form = new WWWForm();
        ...
        form.AddField("colorThierd", thierd);
        form.AddField("nickname", nickname);
