...
public class DataLoader : MonoBehaviour
{
    ...
    [SerializeField] private Palette main, second, thierd;
    [SerializeField] private WebManager manager;
    [Space] [SerializeField] private Color startMainColor, startSecondColor, startThierdColor;
    ...
    public void SaveData()
    {
        ...
        manager.SaveData(player.id, player.nickname, player.colorMain, player.colorSecond, player.colorThierd);
    }
}
